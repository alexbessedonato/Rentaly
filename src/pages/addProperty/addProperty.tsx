            ...
            <DialogContent className="sm:max-w-sm backdrop-blur-md bg-white/90">
                ...
                <form onSubmit={(e) => {
                    ...
                    <form.Field name="insurance_file">
                        {(field) => (
                            <div className="space-y-1">
                                <Label htmlFor={field.name}>Póliza de seguro (PDF o Imagen)</Label>
                                <Input
                                    id={field.name}
                                    type="file"
                    ...
                    <form.Field name="contract_file">
                        {(field) => (
                            <div className="space-y-1">
                                <Label htmlFor={field.name}>Contrato de alquiler (PDF o Imagen)</Label>
                                <Input
                                    id={field.name}
                                    type="file"
                                    accept=".pdf,.jpg,.jpeg,.png"
                    ...
                    <DialogFooter className="pt-4">
                        <Button type="submit" className="w-full" disabled={form.state.isSubmitting}>
                            {form.state.isSubmitting ? "Añadiendo..." : "Añadir Propiedad"}
                        </Button>
                    </DialogFooter>
