...
import { useTenantsNavigation } from "@/features/tenants/hooks/useTenantsNavigation";
...
import { addTenantAction } from "@/features/tenants/actions/tenantsActions";

export const AddTenant = () => {

    const { navigateToHome } = useTenantsNavigation();
                ...
                <form onSubmit={(e) => {
                    ...
                    <DialogFooter className="pt-4">
                        <Button type="submit" className="w-full" disabled={form.state.isSubmitting}>
                            {form.state.isSubmitting ? "Añadiendo..." : "Añadir Inquilino"}
                        </Button>
                    </DialogFooter>
