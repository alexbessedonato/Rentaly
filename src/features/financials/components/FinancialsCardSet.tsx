import { useFinancialsCardSetViewModel } from "../hooks/useFinancialsCardSetViewModel";
import { Card, CardContent, CardHeader, CardTitle } from "@/components/ui/card";

export const FinancialCardSet = () => {
    const { cards, isLoading, error } = useFinancialsCardSetViewModel();
